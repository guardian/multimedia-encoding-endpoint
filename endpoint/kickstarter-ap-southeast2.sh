...
[database]
dbhost[] = "gnm-mm-***REMOVED***-oz2.c8hzpbizpgfw.ap-southeast-2.rds.amazonaws.com"
...
curl https://s3-eu-west-1.amazonaws.com/gnm-multimedia-archivedtech/endpoint_15dec14.zip > /tmp/install.zip
mkdir /tmp/install
